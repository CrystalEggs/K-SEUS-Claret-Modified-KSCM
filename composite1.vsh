...
//colors for shadows/sunlight and sky
	...
	vec3 noon_sun;
	 noon_sun.r = mix(1.05, 1.00, rayleigh);
	...
	sunrise_amb = vec3(0.19f, 0.25f, 0.6f) * 0.15f;
	noon_amb    = vec3(0.15f, 0.29f, 0.99f);
	midnight_amb = vec3(0.03f, 0.05f, 0.45f) * 0.025f;
	...
	colorTorchlight = vec3(0.25f, 0.25f, 0.25f);
